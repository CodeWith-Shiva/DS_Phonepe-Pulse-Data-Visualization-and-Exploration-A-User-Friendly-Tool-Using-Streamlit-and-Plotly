...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Shivashankar",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Shivashankar*!
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/Shivashankar/Phonepe_Pulse_Data_Visualization")
